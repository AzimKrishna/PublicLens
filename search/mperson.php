...
$sql_nof_city = "SELECT DISTINCT(city) FROM apr_miss";
$sql_m_peopl = "SELECT p_id, flname, city, pimg_newname FROM apr_miss";
...
<div class="home-section">
    <div class="bg-art-small">
        ...
        <div class="bg-art-quote" style="padding-top: 70px; font-size:40px;">
            ...
            <h1 style="font-size:40px;"><mark><?php echo $missing; ?> people</mark></h1>
            </div>
        </div>
    </div>
                    ...
                    <?php
                        if(mysqli_num_rows($nof_city) > 0){
                            while($city = mysqli_fetch_assoc($nof_city)){
                                ?>
                                    <option value="<?= $city['city']; ?>"><?php echo $city['city'];?></option>
                                <?php
                            }
                        }
                    ?>
                    ...
                    <?php
                        if(mysqli_num_rows($m_peopl) > 0){
                            while($profiles = mysqli_fetch_assoc($m_peopl)){
                                ?>
                                    <div class="containers" onclick="location.href= 'popup/popup.php?id=<?php echo $profiles['p_id']; ?>';">
                                        ...
                                        <div class="card-desc">
                                            ...
                                            <span id="placename"><?php echo $profiles['city'];?></span><br>
                                        </div>
                                    </div>
                                <?php
                            }
