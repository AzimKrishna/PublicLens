...
include '../../codes.php';
$i=1;
$sql_prsn = "SELECT * FROM apr_miss ORDER BY p_id DESC";
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>View missing people</title>
...
<div class="bg-art-small">
        ...
        <div class="bg-art-quote" style="padding-top: 70px; font-size:40px;">
            ...
            <h1 style="font-size:40px; padding-top:40px"><mark><b>All missing person reports</b></mark></h1> 
