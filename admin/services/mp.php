...
include '../../codes.php';
$i=1;
$sql_prsn = "SELECT * FROM add_prsn ORDER BY p_id DESC";
...
<div class="bg-art-small">
        ...
        <div class="bg-art-quote" style="padding-top: 70px; font-size:40px;">
            <div class="bg-art-quote-container" style="margin-left: -210px;">
            <h1 style="font-size:40px; padding-top:40px"><mark><b>New reports panel</b></mark></h1> 
                  ...
                  <tr>
                      ...
                      <td>
                          <form action="../../db/pass.php" method="post">
                              <input type="hidden" name="p_id" value="<?php echo $prsn['p_id']; ?>">
                              <button type="submit" name="del-btn-mp" id='del-btn-spcf' class="enq-del">DEL<i class='bx bx-x' ></i></button>
                          </form>
                      </td>
                  </tr>
              <?php
